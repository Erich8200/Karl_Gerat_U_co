...
LIBART_COMMON_SRC_FILES := \
  ...
  gerat/filter/filter.cc \
  gerat/filter/karlgeratufilter.cc \
  gerat/util/Utilproc.cc \
  gerat/unpack/unpack_globals.cc \
  gerat/util/Defs.cc \
  gerat/util/leb128.cc \
  hprof/hprof.cc \
  image.cc \
...
LIBART_ENUM_OPERATOR_OUT_HEADER_FILES := \
  ...
  gc/space/space.h \
  gc/heap.h \
  gerat/util/Utilproc.h \
  gerat/unpack/unpack_globals.h \
  image.h \
  instrumentation.h \
