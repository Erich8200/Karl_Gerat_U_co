...
// Karl Gerat U-X changed function signature
extern void EnterInterpreterFromInvoke(Thread* self, ArtMethod* method,
                                       mirror::Object* receiver, uint32_t* args, JValue* result, uint32_t force_invoke_flag = 0x00, const DexFile::CodeItem** new_code_item = nullptr)
